  ...
  <div className="frame">
    <div className="frame-2">
      ...
      <p className="text-wrapper">
        ...
        portfolio profesional, dan menghadapi interview kerja dengan percaya
        diri. Pelajari juga soal-soal umum psikotes untuk semakin siap
        memasuki dunia kerja.
      </p>
    </div>
  </div>
  <div className="frame-3">
    <a href="c_video-materi.html">
    ...
    <div className="default-wrapper">
      <div className="default">
        ...
        <div className="frame-4">
          <div className="lorem-ipsum-dolor-wrapper">
            <div className="lorem-ipsum-dolor">
              Menyesuaikan Portfolio untuk Pekerjaan
            </div>
          </div>
          <div className="frame-5">
            <div className="frame-6">
    ...
    <div className="default-wrapper">
      <div className="default">
        ...
        <div className="frame-4">
          <div className="lorem-ipsum-dolor-wrapper">
            <div className="lorem-ipsum-dolor">
              Menguasai Teknik Menjawab Pertanyaan
            </div>
          </div>
          <div className="frame-5">
            <div className="frame-6">
    ...
    <a href="soal.html">
      <div className="default-wrapper">
        <div className="default">
          <img
            className="rectangle"
            src="assets/Rectangle 39_tes logika.svg"
          />
          <div className="frame-4">
            <div className="lorem-ipsum-dolor-wrapper">
              <p className="lorem-ipsum-dolor">
                Tes Logika Penalaran (Logical Reasoning)
              </p>
            </div>
            <div className="frame-5">
              <div className="frame-6">
    ...
    <a href="soal.html">
      <div className="default-wrapper">
        <div className="default">
          <img
            className="rectangle"
            src="assets/Rectangle 39_tes kemapuan.svg"
          />
          <div className="frame-4">
            <div className="lorem-ipsum-dolor-wrapper">
              <p className="lorem-ipsum-dolor">
                Tes Kemampuan Verbal (Verbal Ability)
              </p>
            </div>
            <div className="frame-5">
              <div className="frame-6">
    ...
    <a href="soal.html">
      <div className="default-wrapper">
        <div className="default">
          <img
            className="rectangle"
            src="assets/Rectangle 39_tes numerik.svg"
          />
          <div className="frame-4">
            <div className="lorem-ipsum-dolor-wrapper">
              <p className="lorem-ipsum-dolor">
                Tes Numerik (Numerical Ability Test)
              </p>
            </div>
            <div className="frame-5">
              <div className="frame-6">
    ...
    <a href="soal.html">
      <div className="default-wrapper">
        <div className="default">
          <img
            className="rectangle"
            src="assets/Rectangle 39_tes kemampuan.svg"
          />
          <div className="frame-4">
            <div className="lorem-ipsum-dolor-wrapper">
              <p className="lorem-ipsum-dolor">
                Tes Kemampuan Spasial (Spatial Ability)
              </p>
            </div>
            <div className="frame-5">
              <div className="frame-6">
