...
const Card = ({product}) => {
    ...
    return (
        <Link to={`/products/${slug}` ?? ''} className="flex font-sans flex-col max-w-[370px] rounded-xl flex-wrap p-[12px] bg-[#081116] hover:ring-opacity-40 active:ring-5 active:ring-[#6247eb] hover:ring-4 active:ring-2 active:ring-opacity-90" >
        <>
            <div className="flex flex-col max-w-[370px] flex-wrap p-[12px] bg-[#081116] rounded-xl">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <span className="block font-medium font-sans text-[20px] text-white">
                        {formatToIDRCurrency(price) ?? 'Not for sale'}
                    </span>
                    <div>
                        {stock <= 0 ? (
                        <>
                            <p className="text-sm font-semibold font-sans text-center text-red-500 mb-4">
                                Out of Stock
                            </p>
                            <Button
                            type="submit"
                        ...
                        <>
                            <p className="text-sm mb-4 font-semibold text-left text-yellow-500">
                                <span className="text-sm font-sans text-[#fffff0] text-white text-left">Sisa {stock}</span> (Almost Sold Out) 
                            </p>
                            <Button
                            type="submit"
